...
**[`demo/landing-page/`](demo/landing-page/)** — a launch page for "Bellwether", a fictional schema-migration rehearsal tool. Near-black OKLCH surface at a single hue, one deep cobalt accent split into a fill and a text weight, Geist throughout, tabular-nums metric strip, one scroll-driven fade-up and nothing else moving. **[Open it live →](https://krishna-modi12.github.io/frontend-design-pro/landing-page/)**

![Bellwether landing page — a near-black surface at a single cool hue with one deep cobalt accent, a hero reading "Every migration runs twice." beside a rehearsal report card listing rows touched, traffic replayed, longest lock and observed p95, an hourly write-volume chart marking the recommended quiet window, and a hold verdict in prose](demo/landing-page/screenshot.png)

*[Full page](demo/landing-page/screenshot-full.png) — the metric strip, the three-step sequence, the asymmetric bento and the testimonials.*
