...
**`PERF-04` — no `transition-all`.** It animates every animatable property including ones you never meant to touch, so a layout change elsewhere becomes an animation here. Name the properties.
