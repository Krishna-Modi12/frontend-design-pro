...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **19** | **101** | **348,105 tokens** | **2,099 tokens** | **5,912–7,476** | **59** | **11** |
...
**The route it takes.** *Report*, *severity*, *dark* and *contrast* match the trigger-keyword column, so the registry loads `design-principles` for the information hierarchy, `design-system` for the OKLCH token pair, and `web-interface` for the copy rules — each pulling `core/design-tokens.md`, plus the two universal deps. Roughly 5,900 tokens against 348,105 available.
