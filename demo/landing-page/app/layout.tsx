...
export const metadata: Metadata = {
  title: "Switchyard — release orchestration that knows what is on the track",
  description:
    "Hold a rollout on a siding, move traffic by the increment you choose, and reverse the whole consist from one key. A demo page generated by the frontend-design-pro skill pack.",
};
