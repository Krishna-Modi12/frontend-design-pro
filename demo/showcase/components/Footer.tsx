      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-[1.4fr_1fr_1fr_1fr]">
          ...
          {columns.map((column) => (
            <div key={column.heading}>
              ...
              {/* Plain text, not `<a href="#">`. Wavelet has no real Docs, API
        ...
        <div className="mt-16 border-t border-border pt-8 text-xs text-text-faint">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <span>© 2026 Wavelet Analytics, Inc.</span>
            <span>Built for teams who ship before the anomaly does.</span>
          </div>

          {/*
            Wavelet is not real, and a visitor arriving here cold has no way to
          ...
          */}
          <p className="mt-6 max-w-2xl">
            Wavelet is a fictional product. This page was generated by{" "}
            <a
