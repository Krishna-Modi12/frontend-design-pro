...
1. **Read `SKILL.md`** — the registry, ~2,088 tokens. Read it fully. It holds the identity, the anti-slop wall, and the routing table.
...
5. **Budget: ≤8,000 tokens total.** A typical request lands at 5,794–7,394 — registry + one skill + its declared deps. Over budget: drop the deepest reference first and **say which** in your output.
