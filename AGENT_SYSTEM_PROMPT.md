...
5. **Budget: ≤8,000 tokens total.** A typical request lands at 5,665–7,266 — registry + one skill + its declared deps. Over budget: drop the deepest reference first and **say which** in your output.
