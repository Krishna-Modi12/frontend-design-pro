...
6. **Load a `skills/{id}/references/*.md` file only when the loaded skill file points you at it** for the specific task. That is where the ~429k tokens of depth lives; none of it is loaded by default.
