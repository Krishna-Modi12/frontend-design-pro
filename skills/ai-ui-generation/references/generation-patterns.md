...
Generated output is validated by the same 51 constraints as everything else (`core/validate-checklist.md`). If a generator's output can't pass the parser gate, the fix is the prompt or the registry — not an exemption.
