...
loads a 2,146-token registry that does nothing but route, then pulls in the single
skill your request matched — measured 6,034–7,947 tokens all-in, including that
