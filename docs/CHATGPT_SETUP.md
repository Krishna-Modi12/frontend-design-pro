...
- **The 20-file cap forces a subset.** 100 files in the pack, 20 slots. You are curating in advance exactly the decision the registry was designed to defer until the request arrives. Pick for the work you actually do; a GPT scoped to "landing pages and design systems" beats one that tries to cover all 16 skills.
