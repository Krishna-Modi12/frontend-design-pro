...
Agent:  matches "pricing" → loads catalog/landing-pages/SKILL.md + core/design-tokens.md
        (~6,043 tokens, not the 436,284 available)
```
...
| review, audit, guidelines, wig, copywriting, microcopy, contrast-check, a11y audit, ux rules, live audit, live site, in the browser, how it actually looks, computed contrast | `web-interface` | Reviewing existing UI rather than building new — including a live rendered-DOM audit |
...
| One skill | 848–1,878 |
| Core deps | 2,965–3,924 |
| **Typical request** | **~6,043–7,956** |
| Available depth (loaded only on demand) | **436,284** |
