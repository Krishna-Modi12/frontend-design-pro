...
- **Reference depth** is where the pack shrinks most. ChatGPT's 20-file-per-GPT knowledge cap means you are choosing a subset of 118 reference files before the conversation starts; Claude.ai without a project gets none of them.
