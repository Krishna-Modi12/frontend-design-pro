...
4. Start a new chat and ask for UI in plain language:
   ...
   There are no slash commands. The agent reads the registry, matches your wording against trigger keywords, and loads exactly one skill plus its declared dependencies (~5,999–7,598 tokens). See [USAGE.md](USAGE.md).
