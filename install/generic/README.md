...
2. Point the agent at `SKILL.md` first, by whatever mechanism the host gives you — an attachment, a paste, a rules field, a repo path. It is self-contained (registry, routing table, anti-slop wall, loading protocol, failure handling) and the only file always loaded: 1,857 tokens.
