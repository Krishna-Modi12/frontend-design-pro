...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,099 tokens) always loaded, one matched skill plus its core deps, ~5,965–7,530 tokens per request against 371,905 tokens of on-demand depth.
