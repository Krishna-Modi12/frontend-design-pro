...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,112 tokens) always loaded, one matched skill plus its core deps, ~5,999–7,598 tokens per request against 401,382 tokens of on-demand depth.
