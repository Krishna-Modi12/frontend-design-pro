...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,099 tokens) always loaded, one matched skill plus its core deps, ~5,912–7,476 tokens per request against 344,251 tokens of on-demand depth.
