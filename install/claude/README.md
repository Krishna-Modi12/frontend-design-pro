...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,002 tokens) always loaded, one matched skill plus its core deps, ~5,000–6,300 tokens per request against 333,610 tokens of on-demand depth.
