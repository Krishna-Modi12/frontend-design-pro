...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,018 tokens) always loaded, one matched skill plus its core deps, ~5,665–7,266 tokens per request against 334,051 tokens of on-demand depth.
