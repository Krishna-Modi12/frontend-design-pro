...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (1,895 tokens) always loaded, one matched skill plus its core deps, ~4,800–6,100 tokens per request against 320,865 tokens of on-demand depth.
