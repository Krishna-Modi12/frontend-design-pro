...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,112 tokens) always loaded, one matched skill plus its core deps, ~6,000–7,599 tokens per request against 402,592 tokens of on-demand depth.
