...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (2,149 tokens) always loaded, one matched skill plus its core deps, ~6,037–7,950 tokens per request against 431,931 tokens of on-demand depth.
