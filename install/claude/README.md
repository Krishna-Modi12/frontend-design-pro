...
This is the only host with a real filesystem, so lazy loading works as designed: `SKILL.md` (1,837 tokens) always loaded, one matched skill plus its core deps, ~4,600–5,500 tokens per request against 305,784 tokens of on-demand depth.
